...
export default function PortfolioClient() {
  ...
  return (
    <div className="portfolio-wrapper" style={{ backgroundColor: 'var(--color-background)', color: 'var(--color-foreground)', minHeight: '100vh', fontFamily: '"Inter", sans-serif' }}>
        ...
        <div className="split-hero" style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <div className="hero-text">
            ...
            <motion.p
              ...
              style={{ fontSize: '18px', color: 'var(--color-muted-foreground)', lineHeight: '1.6', maxWidth: '540px', marginBottom: '32px' }}
            >
          ...
          <div className="filter-bar">
            {industries.map(industry => (
              <button
                ...
                style={{
                  background: activeIndustry === industry ? 'var(--color-background)' : 'rgba(255,255,255,0.03)',
                  color: activeIndustry === industry ? '#000000' : 'var(--color-background)',
                  border: '1px solid rgba(255,255,255,0.1)',
                  padding: '12px 28px',
                  borderRadius: '40px',
                  cursor: 'pointer',
                  ...
                  <div className="card-content">
                             ...
                             <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                               {item.results.slice(0,2).map(res => (
                                 <div key={res.metric} style={{ background: 'rgba(255,255,255,0.03)', padding: '20px', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                   <div style={{ fontSize: '28px', fontWeight: '800', color: 'var(--color-foreground)', marginBottom: '6px' }}>{res.value}</div>
                    ...
                    {cardClass === 'card-landscape' && (
                      <>
                        ...
                        <p style={{ color: 'var(--color-muted-foreground)', fontSize: '15px', lineHeight: '1.6', marginBottom: '28px', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>{item.description}</p>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginTop: '28px', paddingTop: '24px', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'baseline', gap: '10px' }}>
                            <span style={{ fontSize: '26px', fontWeight: '800', color: 'var(--color-foreground)' }}>{item.results[0].value}</span>
                    ...
                    {cardClass === 'card-portrait' && (
                      <>
                        ...
                        <div style={{ flex: 1 }}>
                          <p style={{ color: 'var(--color-muted-foreground)', fontSize: '15px', lineHeight: '1.6', marginBottom: '24px', display: '-webkit-box', WebkitLineClamp: 3, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>{item.description}</p>
                        </div>
                        <div style={{ background: 'linear-gradient(to right, rgba(255,255,255,0.02), rgba(255,255,255,0.04))', padding: '24px', borderRadius: '20px', marginTop: 'auto', border: '1px solid rgba(255,255,255,0.03)' }}>
                          ...
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                            <span style={{ fontSize: '32px', fontWeight: '800', color: 'var(--color-foreground)', lineHeight: '1' }}>{item.results[0].value}</span>
      ...
      <section className="cta-section" style={{ maxWidth: '1400px', margin: '0 auto' }}>
        <div className="cta-block">
          ...
          >
            ...
            <p style={{ fontSize: '20px', color: 'var(--color-muted-foreground)', maxWidth: '640px', margin: '0 auto', position: 'relative', zIndex: 1, lineHeight: '1.6' }}>Let's build a solution tailored to your unique challenges. Our engineering team is ready to help you scale.</p>
